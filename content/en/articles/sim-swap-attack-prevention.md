...
title: "SIM Swap Attack: How to Prevent Your Phone Number from Being Hijacked"
date: 2026-06-29
draft: false
categories:
 - Digital Security
...
Attackers collect your personal data from public sources: full name, date of birth, address, ID number. This information is available on social media, online directories, or leaked databases.

### Stage 2: Contacting the carrier
Attackers contact your mobile carrier's customer service, impersonating you. They claim the SIM card is "lost" or "damaged" and request a replacement to a new SIM they hold. With the personal data already collected, they can answer verification questions.

### Stage 3: Takeover
The carrier processes the request and moves your number to the attacker's SIM card. Your phone loses signal. All SMS, including OTP codes, go to the attacker's phone.

### Stage 4: Account hijacking
...
SIM swap attackers gather data from social media to answer carrier verification questions. Hide:
- Full date of birth (especially the year)
- Home address
- Phone numbers in public profiles
- Family information that could be used as security answers

### 4. Enable notifications for important account changes
...
4. **Check login history** in email and important services to find unauthorized access.
5. **Report to law enforcement** with evidence: time of signal loss, notifications received, and unauthorized transactions.
6. **Reevaluate authentication methods** on all accounts and reduce dependence on SMS OTP.

## Frequently asked questions

### Can SIM swapping happen with any carrier?
