...
description: "Kebijakan privasi — data, cookie, Google AdSense, dan hak pengguna."
layout: "page"
type: "page"
url: "/privacy/"
menu:
...
| Organisasi | {{< site "organization" >}} |
| Editor | {{< site "ownerName" >}} |
| Nama legal | {{< site "legalName" >}} |
...
- Menganalisis lalu lintas secara agregat
- Menayangkan iklan (termasuk Google AdSense) bila diaktifkan

Anda dapat mengatur atau menghapus cookie melalui pengaturan peramban. Menolak cookie tertentu dapat memengaruhi fitur situs atau personalisasi iklan.
...
- Meningkatkan konten dan keamanan teknis
- Menayangkan iklan yang relevan (bila AdSense aktif)
...
- Mengakses data pribadi yang kami pegang tentang Anda
...
Ajukan permintaan melalui halaman [Kontak]({{< ref "/contact.md" >}}) atau email **{{< site "contactEmail" >}}**. Kami dapat meminta verifikasi wajar sebelum memproses permintaan.
...
Situs ini tidak ditujukan untuk anak di bawah usia yang disyaratkan hukum setempat untuk menyetujui pemrosesan data. Kami tidak dengan sengaja mengumpulkan data dari anak-anak.
...
Pertanyaan terkait privasi: gunakan halaman **[Kontak]({{< ref "/contact.md" >}})** atau email **{{< site "contactEmail" >}}**.
